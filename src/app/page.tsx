...
export default function Home() {
  ...
  const handleEndCall = async () => {
    const loadingToast = toast.loading("Ending call...");
    ...
    try {
      ...
      if (error instanceof TypeError && error.message.includes("fetch")) {
        ...
        toast.error(
          "Failed to end call properly. Your conversation may not have been saved.",
          {
            duration: 3000,
          }
        );
  ...
  const handleStartCall = () => {
    try {
      ...
      toast.error("Failed to start call. Please refresh and try again.", {
        duration: 3000,
      });
      setIsCallActive(false);
    }
          ...
          <div className="flex flex-col sm:flex-row items-center gap-3">
            {isCallActive ? (
              <button
                ...
                disabled={isLoading}
                className="w-full sm:w-auto flex items-center justify-center gap-2 px-4 py-2 bg-red-500 text-white rounded-lg hover:bg-red-600 transition-colors"
              >
                <PhoneOff size={20} />
                End Call
              </button>
              ...
              <button
                ...
                className="w-full sm:w-auto flex items-center justify-center gap-2 px-4 py-2 bg-green-500 text-white rounded-lg hover:bg-green-600 transition-colors"
              >
                <Phone size={20} />
                Start Call
              </button>
        ...
        >
          <div className="flex items-end gap-4">
            <div
              ...
              onMouseEnter={() => !isCallActive && setShowTooltip(true)}
            ...
            <button
              ...
              className="mb-2 flex items-center justify-center p-3 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
              <Send size={20} />
            </button>
          </div>
